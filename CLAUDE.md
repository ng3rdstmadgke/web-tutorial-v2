...
- **普遍的な設計原則に準拠**: Clean Architecture, DDD, SOLIDの原則, GoFデザインパターンといった普遍的な設計原則に準拠すること
...
- レビュー観点
  - ドリフト検知: 当初、ユーザーとAIで brainstorming して決めた仕様・設計と食い違っている箇所がないか
  - 情報の正確性: context7やweb検索で最新の仕様や公式リファレンスを確認して、内容の正確性をチェックする
...
- コードブロック(コマンド)を積極的に使い、冗長な手順や説明を書かない。
